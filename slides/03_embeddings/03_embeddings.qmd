...
keywords: ["embeddings", "large language models", "machine learning", "nlp"]
format:
    revealjs:
...
![](vis/training_data.png){height=450}
...
![](vis/skip_gram_net_arch.png)

::: fragment

#### We learn to sets of 300 X 10,000 weight matrices
...
![](vis/embeddings_lookup.png)

## Result

::: {.absolute top=75 left=150}
![](vis/word2vec_weight_matrix_lookup_table.png)
:::
...
[Notebook](https://colab.research.google.com/github/nicolaiberk/llm_ws/blob/dimes26/notebooks/03_embeddings.ipynb)
...
![](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExbXk3cXY4ZzM4eDhicWJydzFrNjRpbnFydGhtMGd1aXhsajdrcDBwdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/eH3Ra3DUp3tMylXedo/giphy.gif)
